package com.mobatia.kingsedu.activity.communication.letter.adapter
...
internal class LetterListAdapter (private var newsLetterList: List<LetterResponseListModel>) :
    RecyclerView.Adapter<LetterListAdapter.MyViewHolder>() {
